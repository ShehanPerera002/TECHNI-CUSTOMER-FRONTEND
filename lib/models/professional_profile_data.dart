...
class ProfessionalProfileData {
  ...
  static ProfessionalProfileData getForProfessional(String id) {
    ...
    return data ?? _profileData['plumber-1']!;
  }
  ...
  static const _profileData = {
    ...
    'plumber-1': ProfessionalProfileData(
      ...
      verifiedServices: ['Pipe Installation & Repair', 'Leak Detection & Fixing', 'Drain Unblocking', 'Emergency Repairs'],
    ),
    'plumber-2': ProfessionalProfileData(
      ...
      verifiedServices: ['Water Heater Repair', 'Pipe Installation', 'Leak Detection', 'Drain Cleaning'],
    ),
    'plumber-3': ProfessionalProfileData(
      ...
      verifiedServices: ['Kitchen Plumbing', 'Bathroom Repairs', 'Pipe Installation', 'Emergency Repairs'],
    ),
    'plumber-4': ProfessionalProfileData(
      ...
      verifiedServices: ['Leak Detection & Fixing', 'Pipe Replacement', 'Toilet Repairs', 'Emergency Repairs'],
    ),
    'plumber-5': ProfessionalProfileData(
      ...
      verifiedServices: ['Emergency Repairs', 'Pipe Installation', 'Drain Unblocking', 'Water System Repair'],
    ),
    // Electricians
    'electrician-1': ProfessionalProfileData(
      ...
      verifiedServices: ['Wiring & Rewiring', 'Outlets & Switches', 'Lighting Installation', 'Electrical Repairs'],
    ),
    'electrician-2': ProfessionalProfileData(
      ...
      verifiedServices: ['Panel Upgrades', 'Fault Finding', 'Outlet Installation', 'Safety Inspections'],
    ),
    'electrician-3': ProfessionalProfileData(
      ...
      verifiedServices: ['Lighting Design', 'Smart Home Wiring', 'Electrical Installation', 'Repairs'],
    ),
    'electrician-4': ProfessionalProfileData(
      ...
      verifiedServices: ['General Repairs', 'Wiring', 'Outlet Fixes', 'Electrical Maintenance'],
    ),
    'electrician-5': ProfessionalProfileData(
      ...
      verifiedServices: ['Residential Wiring', 'Lighting', 'Repairs', 'Safety Checks'],
    ),
    // Gardeners
    'gardener-1': ProfessionalProfileData(
      ...
      verifiedServices: ['Lawn Care', 'Pruning', 'Landscaping', 'Garden Maintenance'],
    ),
    'gardener-2': ProfessionalProfileData(
      ...
      verifiedServices: ['Flower Beds', 'Organic Gardening', 'Lawn Care', 'Plant Care'],
    ),
    'gardener-3': ProfessionalProfileData(
      ...
      verifiedServices: ['Lawn Mowing', 'Hedge Trimming', 'Landscaping', 'Garden Design'],
    ),
    'gardener-4': ProfessionalProfileData(
      ...
      verifiedServices: ['Garden Maintenance', 'Weeding', 'Plant Care', 'Lawn Care'],
    ),
    'gardener-5': ProfessionalProfileData(
      ...
      verifiedServices: ['Lawn Care', 'Pruning', 'Fertilizing', 'Seasonal Care'],
    ),
    // Carpenters
    'carpenter-1': ProfessionalProfileData(
      ...
      verifiedServices: ['Furniture Repair', 'Custom Woodwork', 'Installations', 'Cabinetry'],
    ),
    'carpenter-2': ProfessionalProfileData(
      ...
      verifiedServices: ['Doors & Windows', 'Furniture', 'General Carpentry', 'Repairs'],
    ),
    'carpenter-3': ProfessionalProfileData(
      ...
      verifiedServices: ['Furniture Assembly', 'Repairs', 'Custom Pieces', 'Installations'],
    ),
    ...
    'carpenter-5': ProfessionalProfileData(
      ...
      verifiedServices: ['Furniture Repair', 'Custom Work', 'Installations', 'Maintenance'],
    ),
    // Painters
    'painter-1': ProfessionalProfileData(
      ...
      verifiedServices: ['Interior Painting', 'Exterior Painting', 'Wall Preparation', 'Touch-ups'],
    ),
    'painter-2': ProfessionalProfileData(
      ...
      verifiedServices: ['Residential Painting', 'Commercial', 'Wallpaper', 'Decorative Finishes'],
    ),
    'painter-3': ProfessionalProfileData(
      ...
      verifiedServices: ['Interior/Exterior', 'Color Consult', 'Wall Painting', 'Repairs'],
    ),
    'painter-4': ProfessionalProfileData(
      ...
      verifiedServices: ['Full Repaints', 'Touch-ups', 'Decorative', 'Wall Prep'],
    ),
    'painter-5': ProfessionalProfileData(
      ...
      verifiedServices: ['Interior Painting', 'Exterior', 'Texture Work', 'Maintenance'],
    ),
  };
}
